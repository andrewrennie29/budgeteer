...
class BudgetTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create budget_type" do
    assert_difference('BudgetType.count') do
      post budget_types_url, params: { budget_type: { budget_disposition_id: @budget_type.budget_disposition_id, budget_type: @budget_type.budget_type } }
    end
  ...
  test "should update budget_type" do
    patch budget_type_url(@budget_type), params: { budget_type: { budget_disposition_id: @budget_type.budget_disposition_id, budget_type: @budget_type.budget_type } }
