...
class BudgetPeriodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create budget_period" do
    assert_difference('BudgetPeriod.count') do
      post budget_periods_url, params: { budget_period: { days: @budget_period.days, frequency: @budget_period.frequency, period: @budget_period.period } }
    end
  ...
  test "should update budget_period" do
    patch budget_period_url(@budget_period), params: { budget_period: { days: @budget_period.days, frequency: @budget_period.frequency, period: @budget_period.period } }
